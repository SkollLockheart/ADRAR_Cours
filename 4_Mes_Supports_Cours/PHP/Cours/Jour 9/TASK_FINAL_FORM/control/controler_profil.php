<?php
    ...
    if(isset($_SESSION['connexion'])){
        $message_profil = '<h3>Nom et Prénom : '.$_SESSION['name_user'].' '.$_SESSION['first_name_user'].'.</h3><h3>Login: '.$_SESSION['login_utilisateur'].'.</h3><h3>ID: '.$_SESSION['id_utilisateur'].'.</h3>';
    }else{
        echo 'test';
